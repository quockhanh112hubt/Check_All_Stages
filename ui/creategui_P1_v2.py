...
class ModernStageCard(tk.Frame):
    ...
    def __init__(self, parent, stage_name, **kwargs):
        ...
        # Smaller status indicator to match P140 sizing
...
class Data_P1EZ_Checker_V2:
    ...
    def __init__(self, root):
        ...
        root.title(f"P1 Production Data Tracker v{get_current_version()}")
    ...
    def _create_header(self, parent):
        ...
        title = tk.Label(title_frame, text="P1 PRODUCTION LINE", 
    ...
    def _create_stages_section(self, parent):
        ...
        progress_label = tk.Label(title_frame, text="19 Stages", 
                                 font=('Segoe UI', 10),
                                 bg=COLORS['white'], fg=COLORS['text_secondary'])
    ...
    def _create_log_section(self, parent):
        ...
        # reduce log height to save vertical space
    ...
    def _start_background_checks(self, mcu_id):
        stage_configs = [
            ('FIRMWARE', get_data_firmware_P1, 'Firmware'),
            ('PBA', get_data_pba_function_P1, 'PBA Function'),
            ('HEATER', get_data_heater_P1, 'Heater'),
            ('3QR_MATCH', get_data_matching_P1, '3QR Matching'),
            ('CHARGE', get_data_charge_P1, 'Charge Test'),
            ('CALI', get_data_cali_P1, 'Calibration'),
            ('VERIFI', get_data_verifi_P1, 'Verification'),
            ('MMI', get_data_mmi_P1, 'MMI Check'),
            ('VIBRATION', get_data_vibration_P1, 'Vibration'),
            ('SN_WRITE', get_data_snwriting_P1, 'SN Writing'),
            ('FINAL', get_data_final_P1, 'Final Test'),
...
def create_gui_P1_v2(create_login_ui, create_gui_P230, create_gui_P4, create_gui_P140):
    def logout():
        root_P1.destroy()
        create_login_ui()
    ...
    def switch_to_P230():
        root_P1.destroy()
        create_gui_P230(create_login_ui, create_gui_P1_v2, create_gui_P4, create_gui_P140)

    def switch_to_P4():
        root_P1.destroy()
        create_gui_P4(create_login_ui, create_gui_P1_v2, create_gui_P230, create_gui_P140)

    def switch_to_P140():
        root_P1.destroy()
        create_gui_P140(create_login_ui, create_gui_P1_v2, create_gui_P230, create_gui_P4)

    root_P1 = tk.Tk()
    
    # Modern Status Bar
    status_frame = tk.Frame(root_P1, bg=COLORS['dark'], height=35)
    ...
    ui = Data_P1EZ_Checker_V2(root_P1)
    root_P1.mainloop()
