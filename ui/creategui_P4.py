...
class Data_P4_Checker:
    ...
    def __init__(self, root):
        ...
        lbl_Name1 = tk.Label(root, text="P4 EACH STAGE", font=("Arial", 22, "bold italic"))
        ...
        self.name_sleep.place(x=610, y=270, width=105, height=20)
        ...
        self.name_sensor.place(x=490, y=420, width=105, height=20)

        self.result_sn = ttk.Label(root, text="")
        self.result_sn.place(x=385, y=350, width=70, height=70)
        self.label_sn = ttk.Label(root, text="")
        self.label_sn.place(x=340, y=365, width=35, height=40)
        self.name_sn = ttk.Label(root, text="", anchor="center")
        self.name_sn.place(x=370, y=420, width=100, height=20)

        self.result_final = ttk.Label(root, text="")
        self.result_final.place(x=265, y=350, width=70, height=70)
        self.label_final = ttk.Label(root, text="")
        self.label_final.place(x=220, y=365, width=35, height=40)
        self.name_final = ttk.Label(root, text="", anchor="center")
        self.name_final.place(x=250, y=420, width=100, height=20)

        self.result_device = ttk.Label(root, text="")
        self.result_device.place(x=145, y=350, width=70, height=70)
        self.label_device = ttk.Label(root, text="")
        self.label_device.place(x=100, y=365, width=35, height=40)
        self.name_device = ttk.Label(root, text="", anchor="center")
        self.name_device.place(x=130, y=420, width=100, height=20)

        self.result_giftbox = ttk.Label(root, text="")
        self.result_giftbox.place(x=25, y=350, width=70, height=70)
        self.label_giftbox = ttk.Label(root, text="")
        self.label_giftbox.place(x=40, y=450, width=35, height=40)
        self.name_giftbox = ttk.Label(root, text="", anchor="center")
        self.name_giftbox.place(x=10, y=420, width=100, height=20)

        self.result_film = ttk.Label(root, text="")
        self.result_film.place(x=25, y=500, width=70, height=70)
        self.label_film = ttk.Label(root, text="")
        self.label_film.place(x=100, y=515, width=35, height=40)
        self.name_film = ttk.Label(root, text="", anchor="center")
        self.name_film.place(x=10, y=570, width=100, height=20)

        self.result_sleeve = ttk.Label(root, text="")
        self.result_sleeve.place(x=145, y=500, width=70, height=70)
        self.label_sleeve = ttk.Label(root, text="")
        self.label_sleeve.place(x=220, y=515, width=35, height=40)
        self.name_sleeve = ttk.Label(root, text="", anchor="center")
        self.name_sleeve.place(x=130, y=570, width=100, height=20)

        self.result_weigh = ttk.Label(root, text="")
        self.result_weigh.place(x=265, y=500, width=70, height=70)
        self.label_weigh = ttk.Label(root, text="")
        self.label_weigh.place(x=340, y=515, width=35, height=40)
        self.name_weigh = ttk.Label(root, text="", anchor="center")
        self.name_weigh.place(x=250, y=570, width=100, height=20)

        self.result_carton = ttk.Label(root, text="")
        self.result_carton.place(x=385, y=500, width=70, height=70)
        self.label_carton = ttk.Label(root, text="")
        self.label_carton.place(x=460, y=515, width=35, height=40)
        self.name_carton = ttk.Label(root, text="", anchor="center")
        self.name_carton.place(x=370, y=570, width=100, height=20)

        self.result_pallet = ttk.Label(root, text="")
        self.result_pallet.place(x=505, y=500, width=70, height=70)
        self.label_pallet = ttk.Label(root, text="")
        self.label_pallet.place(x=580, y=515, width=35, height=40)
        self.name_pallet = ttk.Label(root, text="", anchor="center")
        self.name_pallet.place(x=490, y=570, width=100, height=20)

        self.result_ship = ttk.Label(root, text="")
        self.result_ship.place(x=625, y=500, width=70, height=70)
        self.name_ship = ttk.Label(root, text="", anchor="center")
        self.name_ship.place(x=610, y=570, width=100, height=20)
    ...
    def show_result_firmware(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_firmware_P4, self.result_firmware, self.label_firmware, self.name_firmware, "FIRMWARE", 'Resource/arrowtoleft.png', "Firmware")
        self.root.after(10, self.show_result_pba, mcu_id, log)

    def show_result_pba(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_pba_function_P4, self.result_pba, self.label_pba, self.name_pba, "PBA_FUNCTION", 'Resource/arrowtoleft.png', "Function PBA")
        self.root.after(10, self.show_result_heater, mcu_id, log)

    def show_result_heater(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_heater_P4, self.result_heater, self.label_heater, self.name_heater, "HEATER_TEST", 'Resource/arrowtoleft.png', "Heater_Test")
        self.root.after(10, self.show_result_leak, mcu_id, log)

    def show_result_leak(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_leak_P4, self.result_leak, self.label_leak, self.name_leak, "LEAK_TEST", 'Resource/arrowtoleft.png', "Leak")
        self.root.after(10, self.show_result_matching, mcu_id, log)

    def show_result_matching(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_matching_P4, self.result_matching, self.label_matching, self.name_matching, "3QR_MATCHING", 'Resource/arrowtoleft.png', "Matching 3QR")
        self.root.after(10, self.show_result_sleep, mcu_id, log)

    def show_result_sleep(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_sleep_P4, self.result_sleep, self.label_sleep, self.name_sleep, "SLEEP_CURRENT", 'Resource/arrowtoleft.png', "Sleep Current")
        self.root.after(10, self.show_result_display, mcu_id, log)

    def show_result_display(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_display_P4, self.result_lcdled, self.label_lcdled, self.name_lcdled, "DISPLAY_MMI1", 'Resource/arrowtoleft.png', "Display")
        self.root.after(10, self.show_result_charge, mcu_id, log)

    def show_result_charge(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_charge_P4, self.result_charge, self.label_charge, self.name_charge, "CHARGE", 'Resource/arrowtodown.png', "Charge")
        self.root.after(10, self.show_result_cali, mcu_id, log)

    def show_result_cali(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_cali_P4, self.result_cali, self.label_cali, self.name_cali, "CALIBRATION", 'Resource/arrowtoright.png', "Calibration")
        self.root.after(10, self.show_result_verifi, mcu_id, log)

    def show_result_verifi(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_verifi_P4, self.result_verifi, self.label_verifi, self.name_verifi, "VERIFICATION", 'Resource/arrowtoright.png', "Verification")
        self.root.after(10, self.show_result_puffing, mcu_id, log)

    def show_result_puffing(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_puffing_P4, self.result_puff, self.label_puff, self.name_puff, "PUFFING", 'Resource/arrowtoright.png', "Puffing")
        self.root.after(10, self.show_result_optical_cali_P4, mcu_id, log)

    def show_result_optical_cali_P4(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_optical_cali_P4, self.result_sensor, self.label_sensor, self.name_sensor, "OPTICAL & STICK", 'Resource/arrowtoright.png', "Optical_Cali & Stick Calibration")
        self.root.after(10, self.show_result_snwriting, mcu_id, log)

    def show_result_snwriting(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_snwriting_P4, self.result_sn, self.label_sn, self.name_sn, "SN_WRITING", 'Resource/arrowtoright.png', "SN Writing")
        self.root.after(10, self.show_result_final, mcu_id, log)

    def show_result_final(self, mcu_id, log):
        self.show_result(mcu_id, log, get_data_final_P4, self.result_final, self.label_final, self.name_final, "FINAL_TEST", 'Resource/arrowtoright.png', "Final Test")
        self.root.after(10, self.show_result_deviceid, mcu_id, log)
    ...
    def show_result_deviceid(self, mcu_id, log):
        ...
        self.root.after(10, self.show_result_giftbox, mcu_id, log)
    ...
    def show_result_giftbox(self, mcu_id, log):
        ...
        self.root.after(10, self.show_result_film, mcu_id, log)
    ...
    def show_result_film(self,mcu_id, log):
        ...
        self.root.after(10, self.show_result_sleeve, mcu_id, log)
    ...
    def show_result_sleeve(self,mcu_id, log):
        ...
        self.root.after(10, self.show_result_weigh, mcu_id, log)
    ...
    def show_result_weigh(self,mcu_id, log):
        ...
        self.root.after(10, self.show_result_carton, mcu_id, log)
    ...
    def show_result_carton(self, mcu_id, log):
        ...
        self.root.after(10, self.show_result_pallet, mcu_id, log)
    ...
    def show_result_pallet(self, mcu_id, log):
        ...
        self.root.after(10, self.show_result_shipping, mcu_id, log)
    ...
    def start(self,mcu_id):
        ...
        self.root.after(10, self.show_result_firmware, mcu_id, self.Log)
...
def create_gui_P4(create_login_ui, create_gui_P1, create_gui_P230, create_gui_P140):
    ...
    Copyright = ttk.Label(root_P4, text="Powered by ITM Semiconductor Vietnam Company Limited - IT Team. Copyright © 2024 all rights reserved.", anchor="w")
