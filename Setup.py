...
def main(progress_var):
    ...
    target_path = r"C:\Check_All_Stage\Check_All_Stage.exe"
    shortcut_path = os.path.join(winshell.desktop(), "Check_All_Stage.lnk")
...
class Ui_InextendChecker:
    ...
    def __init__(self, root):
        ...
        root.title(f"ECIGA Each Stage Data Checker setup")
        ...
        lbl_Name1 = tk.Label(root, text="ECIGA EACH STAGE", font=("Arial", 22, "bold italic"))
        ...
        lbl_detail = tk.Label(root, text="Trình cài đặt ECIGA Each Stage lên máy tính của bạn.", font=("Arial", 12, "bold"), anchor='w')
